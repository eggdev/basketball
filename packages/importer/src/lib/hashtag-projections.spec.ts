...
const csv = `PLAYER,POS,TEAM,GP,FG%,FT%,3PM,PTS,TREB,AST,STL,BLK,TO
N.Jokic,C,DEN,72,"0.573 (10.5/18.3)","0.816 (5.6/6.8)",1.8,28.4,12.7,10.4,1.6,0.7,3.5
Rookie Example,PG SG,BKN,70,"0.450 (7.2/16.0)","0.800 (4.0/5.0)",2.2,20.6,4.2,6.1,1.2,0.3,2.5
`;
